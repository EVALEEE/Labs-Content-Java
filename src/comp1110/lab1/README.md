...
This lab contains material from modules [**I1**](https://comp.anu.edu.au/courses/comp1110/lectures/theme/#I1) (Academic Honesty),
  [**J1**](https://comp.anu.edu.au/courses/comp1110/lectures/theme/#J1) (Basic I/O) and [**S1**](https://comp.anu.edu.au/courses/comp1110/lectures/theme/#S1) (Gitlab).
...
We **strongly encourage** you to setup and run this exercises on both the lab computers and on your own device so you are familiar with both. We will have limited capacity to help with basic technical issues surrounding the tools beyond to the first week, so make sure you resolve them now.

There is a step-by-step video from last semester [video](https://comp.anu.edu.au/courses/comp1110/help/mp4/lab1.mp4) showing you how to complete this lab in the lab environment in the second half.
Note that the GitLab UI has changed a bit since then.
...
Follow the instructions on the course web page for [setting up the software for your home computer](https://comp.anu.edu.au/courses/comp1110/help/software/). 
...
2.  **Fork the comp1110-labs repository.**
    ...
    Notice that the text at top-left of the main part of the page is "comp1110 / comp1110-labs", which tells you that the owner is the group "comp1110", and that the repository is called "comp1110-labs".
    ...
    Notice that the name at top-left of the main part of the page has changed to show that you own this new repo.
...
3.  **Find this document within your labs repo.**
    ...
    You should now be looking at the project page for your own fork of the comp1110-labs project (you will see "Your Name / comp1110-labs" at top-left of the main part of your GitLab page in your browser).
    ...
    If you're in any doubt about which version of the document you're looking at, check the text at top-left of the main part of the page, and you should see your name followed by a "/" and then "comp1110-labs".
    You can also check the URL, which should be something like:
    `https://gitlab.cecs.anu.edu.au/u1234567/comp1110-labs/tree/main/src/comp1110/lab1`.
...
* In the fourth column, in *just a few words*, write what you *will do* for the course in the week to come.
  ...
  Remember: there are a lot of [people and resources that can help you](https://comp.anu.edu.au/courses/comp1110/help/) in understanding the course material.
...
Use your browser to navigate to your GitLab project page, then select the blue **Code** button on the right to reveal the HTTPS and SSH URLs for your repo.
...
If Java version 17 is available, select it and click **OK**.
...
If after following the above steps and reading the [instructions for working remotely](https://comp.anu.edu.au/courses/comp1110/help/software/#javafx) the program will still not execute, please seek help from your peers and your tutor.
...
Before you start, you must have [set up the software for your home computer](https://comp.anu.edu.au/courses/comp1110/help/software/).
...
* **Push**: Pushing is the act of taking one or multiple changes (commits) made to the repo, each labelled with a commit message, and copying these changes to another version of the repository (such as the one on GitLab).
  ...
  By default, these will be `origin` and `main` respectively.
